...
for row in range(0, nrows):
    for col in range(0, ncols):
        ...
        for chain in chains:
            x = superData[sims[col]][reps[row]][chain]["m2_m1_dist"]
            t = range(0, len(x))
        ...
        # Set x-lim and y-lim.
        subplt.set_ylim([11, 21])
        subplt.set_xlim([0, 1000])

        subplt.text(15, 11.5, str(row+1))
        ...
        if col != 0:
            ...
            subplt.set_ylabel(r'M2-M1(-) Dist. ($\AA$)', size=18)
...
fig.savefig('m2m1dist.png')
fig.clf()
os.system("convert m2m1dist.png -trim m2m1dist.png")
