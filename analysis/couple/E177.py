...
def task(residue, target, sim, rep, chain1, chain2):
    ...
    sel1 = u.select_atoms(f'chainID {chain1} and resid 177:178 and {carboxylAtoms}')
...
if opMode == 2:
    ...
    for comb in combs:
        ...
        nameList = [f'No [E177,D178]-{fullTargetName}', f'[E177,D178]-{fullTargetName}']
        width    = 0.2
        ...
        for metric in metrics:
            ...
            for idx in [0, 1]:
                ...
                if idx == 0:
                    subplt.set_ylabel(f'Not [E177,D178]-{fullTargetName}')
                    subplt.legend(loc='best', prop={'size': 14})

                if idx == 1:
                    subplt.set_ylabel(f'[E177,D178]-{fullTargetName}')
